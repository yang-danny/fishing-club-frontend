...
const ProductDetails = async ({
  ...
  <div className="bg-slate-200 dark:bg-sky-950">
      ...
      <div className="flex flex-col justify-center items-start gap-16 px-96 py-5 max-md:px-10">
        <p className="text-heading3-bold text-sky-900">Description:</p>
        <p className="text-small-medium text-justify text-grey-2">
      ...
      />
      <div className="flex flex-col items-start px-96 py-5 max-md:px-10">
        <p className="text-heading3-bold text-sky-900">Related Products</p>
